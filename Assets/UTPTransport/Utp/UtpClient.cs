...
namespace Utp
{
	...
	struct ClientUpdateJob : IJob
	{
		...
		public void Execute()
		{
			...
			while ((netEvent = connection.PopEvent(driver, out Unity.Collections.DataStreamReader stream)) != NetworkEvent.Type.Empty)
	...
	struct ClientSendJob : IJob
	{
		...
		public void Execute()
		{
			...
			int writeStatus = driver.BeginSend(pipeline, connection, out Unity.Collections.DataStreamWriter writer);
